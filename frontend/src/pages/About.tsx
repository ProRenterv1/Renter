...
const pillars = [
  ...
  },
  {
    ...
    description:
      "Renter is powered by the people who list their tools and the neighbours who keep them in use, not by warehouses.",
  },
  {
    icon: CheckCircle2,
      ...
      <main className="bg-background">
        <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 space-y-4 text-muted-foreground">
            <p>
              Renting the right tool should be simple. Renter was created to make sure anyone can find
